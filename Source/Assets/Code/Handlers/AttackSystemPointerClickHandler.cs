...
namespace ECSDemo {
    ...
    public class AttackSystemPointerClickHandler {
        ...
        private string StringNode4 = "AttackSystem  - Entity attacked.";
        ...
        public virtual System.Collections.IEnumerator Execute() {
            ActionNode1_message = StringNode4;
            // ActionNode
            while (this.DebugInfo("","ce7ff8bf-0932-4fd2-b880-30ecb65ca827", this) == 1) yield return null;
            // Visit uFrame.Actions.DebugLibrary.LogMessage
            uFrame.Actions.DebugLibrary.LogMessage(ActionNode1_message);
            // PublishEventNode
            while (this.DebugInfo("ce7ff8bf-0932-4fd2-b880-30ecb65ca827","04a98bb7-9b5f-480b-88d9-2e378a1a9cc6", this) == 1) yield return null;
